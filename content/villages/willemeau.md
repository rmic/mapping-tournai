+++
title = "Willemeau"
description = "Current street-level imagery coverage and capture priorities for Willemeau."
generated = true
+++

The current baseline classifies 0% of the analysed road length in Willemeau as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/willemeau-coverage.geojson" kind="coverage" title="Willemeau coverage status" >}}
