+++
title = "Saint-Maur"
description = "Current street-level imagery coverage and capture priorities for Saint-Maur."
generated = true
+++

The current baseline classifies 10.89% of the analysed road length in Saint-Maur as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/saint-maur-coverage.geojson" kind="coverage" title="Saint-Maur coverage status" >}}
