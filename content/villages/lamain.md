+++
title = "Lamain"
description = "Current street-level imagery coverage and capture priorities for Lamain."
generated = true
+++

The current baseline classifies 14.02% of the analysed road length in Lamain as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/lamain-coverage.geojson" kind="coverage" title="Lamain coverage status" >}}
