+++
title = "Templeuve"
description = "Current street-level imagery coverage and capture priorities for Templeuve."
generated = true
+++

The current baseline classifies 39.03% of the analysed road length in Templeuve as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
| Partial length | 14 km |
| Missing length | 43 km |
| Covered percentage | 39.03% |
...
{{< leaflet-map data="/maps/data/current/areas/templeuve-coverage.geojson" kind="coverage" title="Templeuve coverage status" >}}
