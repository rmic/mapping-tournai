+++
title = "Hertain"
description = "Current street-level imagery coverage and capture priorities for Hertain."
generated = true
+++

The current baseline classifies 40.7% of the analysed road length in Hertain as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/hertain-coverage.geojson" kind="coverage" title="Hertain coverage status" >}}
