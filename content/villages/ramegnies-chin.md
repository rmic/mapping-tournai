...
description = "Current street-level imagery coverage and capture priorities for Ramegnies-Chin."
generated = true
+++

The current baseline classifies 32.48% of the analysed road length in Ramegnies-Chin as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/ramegnies-chin-coverage.geojson" kind="coverage" title="Ramegnies-Chin coverage status" >}}
