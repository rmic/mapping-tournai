+++
title = "Melles"
description = "Current street-level imagery coverage and capture priorities for Melles."
generated = true
+++

The current baseline classifies 48.96% of the analysed road length in Melles as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/melles-coverage.geojson" kind="coverage" title="Melles coverage status" >}}
