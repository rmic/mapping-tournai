+++
title = "Chercq"
description = "Current street-level imagery coverage and capture priorities for Chercq."
generated = true
+++

The current baseline classifies 22.47% of the analysed road length in Chercq as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.

## Current coverage

| Indicator | Value |
| --- | ---: |
| Total road length | 17 km |
| Covered length | 4 km |
| Partial length | 2 km |
| Missing length | 11 km |
| Covered percentage | 22.47% |
...
{{< leaflet-map data="/maps/data/current/areas/chercq-coverage.geojson" kind="coverage" title="Chercq coverage status" >}}
