+++
title = "Mont-Saint-Aubert"
description = "Current street-level imagery coverage and capture priorities for Mont-Saint-Aubert."
generated = true
+++

The current baseline classifies 25.14% of the analysed road length in Mont-Saint-Aubert as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/mont-saint-aubert-coverage.geojson" kind="coverage" title="Mont-Saint-Aubert coverage status" >}}
