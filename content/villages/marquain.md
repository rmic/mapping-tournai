+++
title = "Marquain"
description = "Current street-level imagery coverage and capture priorities for Marquain."
generated = true
+++

The current baseline classifies 13.17% of the analysed road length in Marquain as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
| Covered length | 5 km |
| Partial length | 7 km |
| Missing length | 28 km |
| Covered percentage | 13.17% |
...
{{< leaflet-map data="/maps/data/current/areas/marquain-coverage.geojson" kind="coverage" title="Marquain coverage status" >}}
