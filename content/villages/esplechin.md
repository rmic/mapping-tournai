+++
title = "Esplechin"
description = "Current street-level imagery coverage and capture priorities for Esplechin."
generated = true
+++

The current baseline classifies 0% of the analysed road length in Esplechin as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/esplechin-coverage.geojson" kind="coverage" title="Esplechin coverage status" >}}
