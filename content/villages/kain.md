...
The current baseline classifies 4.48% of the analysed road length in Kain as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
| Covered length | 5 km |
| Partial length | 27 km |
| Missing length | 70 km |
| Covered percentage | 4.48% |
