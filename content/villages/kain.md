+++
title = "Kain"
description = "Current street-level imagery coverage and capture priorities for Kain."
generated = true
+++

The current baseline classifies 16.24% of the analysed road length in Kain as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
| Covered length | 16 km |
| Partial length | 8 km |
| Missing length | 76 km |
| Covered percentage | 16.24% |
...
{{< leaflet-map data="/maps/data/current/areas/kain-coverage.geojson" kind="coverage" title="Kain coverage status" >}}
