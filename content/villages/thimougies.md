+++
title = "Thimougies"
description = "Current street-level imagery coverage and capture priorities for Thimougies."
generated = true
+++

The current baseline classifies 0% of the analysed road length in Thimougies as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.

## Current coverage

| Indicator | Value |
| --- | ---: |
| Total road length | 12 km |
| Covered length | 0 km |
| Partial length | 0 km |
...
{{< leaflet-map data="/maps/data/current/areas/thimougies-coverage.geojson" kind="coverage" title="Thimougies coverage status" >}}
