+++
title = "Vezon"
description = "Current street-level imagery coverage and capture priorities for Vezon."
generated = true
+++

The current baseline classifies 13.88% of the analysed road length in Vezon as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.

## Current coverage

| Indicator | Value |
| --- | ---: |
| Total road length | 30 km |
| Covered length | 4 km |
| Partial length | 0 km |
| Missing length | 26 km |
| Covered percentage | 13.88% |
...
{{< leaflet-map data="/maps/data/current/areas/vezon-coverage.geojson" kind="coverage" title="Vezon coverage status" >}}
