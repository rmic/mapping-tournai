+++
title = "Quartes"
description = "Current street-level imagery coverage and capture priorities for Quartes."
generated = true
+++

The current baseline classifies 45.61% of the analysed road length in Quartes as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/quartes-coverage.geojson" kind="coverage" title="Quartes coverage status" >}}
