+++
title = "Ere"
description = "Current street-level imagery coverage and capture priorities for Ere."
generated = true
+++

The current baseline classifies 0% of the analysed road length in Ere as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/ere-coverage.geojson" kind="coverage" title="Ere coverage status" >}}
