+++
title = "Béclers"
description = "Current street-level imagery coverage and capture priorities for Béclers."
generated = true
+++

The current baseline classifies 40.97% of the analysed road length in Béclers as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/beclers-coverage.geojson" kind="coverage" title="Béclers coverage status" >}}
