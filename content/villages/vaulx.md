+++
title = "Vaulx"
description = "Current street-level imagery coverage and capture priorities for Vaulx."
generated = true
+++

The current baseline classifies 14.53% of the analysed road length in Vaulx as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/vaulx-coverage.geojson" kind="coverage" title="Vaulx coverage status" >}}
