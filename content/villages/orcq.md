+++
title = "Orcq"
description = "Current street-level imagery coverage and capture priorities for Orcq."
generated = true
+++

The current baseline classifies 2.47% of the analysed road length in Orcq as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
{{< leaflet-map data="/maps/data/current/areas/orcq-coverage.geojson" kind="coverage" title="Orcq coverage status" >}}
