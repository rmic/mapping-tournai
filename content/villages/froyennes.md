+++
title = "Froyennes"
description = "Current street-level imagery coverage and capture priorities for Froyennes."
generated = true
+++

The current baseline classifies 0.04% of the analysed road length in Froyennes as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
| Covered length | 0 km |
| Partial length | 36 km |
| Missing length | 26 km |
| Covered percentage | 0.04% |
...
{{< leaflet-map data="/maps/data/current/areas/froyennes-coverage.geojson" kind="coverage" title="Froyennes coverage status" >}}
