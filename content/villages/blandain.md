+++
title = "Blandain"
description = "Current street-level imagery coverage and capture priorities for Blandain."
generated = true
+++

The current baseline classifies 8.6% of the analysed road length in Blandain as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.

## Current coverage

| Indicator | Value |
| --- | ---: |
| Total road length | 82 km |
| Covered length | 7 km |
| Partial length | 16 km |
| Missing length | 59 km |
| Covered percentage | 8.6% |
...
{{< leaflet-map data="/maps/data/current/areas/blandain-coverage.geojson" kind="coverage" title="Blandain coverage status" >}}
