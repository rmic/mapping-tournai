+++
title = "Barry"
description = "Current street-level imagery coverage and capture priorities for Barry."
generated = true
+++

The current baseline classifies 8.72% of the analysed road length in Barry as covered. This page is a working status record for the Mapping Tournai field project and will evolve after future capture sessions.
...
| Covered length | 2 km |
| Partial length | 10 km |
| Missing length | 10 km |
| Covered percentage | 8.72% |
...
{{< leaflet-map data="/maps/data/current/areas/barry-coverage.geojson" kind="coverage" title="Barry coverage status" >}}
